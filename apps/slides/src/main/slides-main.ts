/**
 * Office AI Slides main process — pptx parsing/render-tree building/edit application/saving all live
...
/**
 * Recovery drafts for never-saved decks (wcId → visible path in <Documents>/Office AI):
...
/** Directory where AI-generated drafts are saved: the configurable default save folder (falls back to <Documents>/Office AI) */
...
/**
 * Auto-save the draft to <Documents>/Office AI/<name>.pptx after AI generation completes.
