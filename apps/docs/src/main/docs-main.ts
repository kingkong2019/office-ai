...
const tMain = createI18n({
  zh: {
    ...
    menuWindow: '窗口',
    menuHelp: '帮助',
    menuDocsHelp: 'Office AI Docs 帮助',
  },
  en: {
    ...
    menuWindow: 'Window',
    menuHelp: 'Help',
    menuDocsHelp: 'Office AI Docs Help',
  },
  ja: {
    dlgOpenDoc: '文書を開く',
    filterWord: 'Word 文書',
    ...
    menuWindow: 'ウィンドウ',
    menuHelp: 'ヘルプ',
    menuDocsHelp: 'Office AI Docs ヘルプ',
  },
  ko: {
    dlgOpenDoc: '문서 열기',
    filterWord: 'Word 문서',
    ...
    menuWindow: '창',
    menuHelp: '도움말',
    menuDocsHelp: 'Office AI Docs 도움말',
  },
  fr: {
    ...
    menuWindow: 'Fenêtre',
    menuHelp: 'Aide',
    menuDocsHelp: 'Aide Office AI Docs',
  },
  de: {
    ...
    menuWindow: 'Fenster',
    menuHelp: 'Hilfe',
    menuDocsHelp: 'Office AI Docs-Hilfe',
  },
  es: {
    ...
    menuWindow: 'Ventana',
    menuHelp: 'Ayuda',
    menuDocsHelp: 'Ayuda de Office AI Docs',
  },
  th: {
    ...
    menuWindow: 'หน้าต่าง',
    menuHelp: 'วิธีใช้',
    menuDocsHelp: 'วิธีใช้ Office AI Docs',
  },
  id: {
    ...
    menuWindow: 'Jendela',
    menuHelp: 'Bantuan',
    menuDocsHelp: 'Bantuan Office AI Docs',
  },
  ru: {
    ...
    menuWindow: 'Окно',
    menuHelp: 'Справка',
    menuDocsHelp: 'Справка Office AI Docs',
  },
  ar: {
    ...
    menuWindow: 'نافذة',
    menuHelp: 'تعليمات',
    menuDocsHelp: 'تعليمات Office AI Docs',
  },
  pt: {
    dlgOpenDoc: 'Abrir Documento',
    ...
    menuWindow: 'Janela',
    menuHelp: 'Ajuda',
    menuDocsHelp: 'Ajuda do Office AI Docs',
  },
  it: {
    ...
    menuWindow: 'Finestra',
    menuHelp: 'Aiuto',
    menuDocsHelp: 'Guida di Office AI Docs',
  },
  pl: {
    ...
    menuWindow: 'Okno',
    menuHelp: 'Pomoc',
    menuDocsHelp: 'Pomoc Office AI Docs',
  },
  nl: {
  ...
  he: {
    ...
    menuWindow: 'חלון',
    menuHelp: 'עזרה',
    menuDocsHelp: 'עזרה של Office AI Docs',
  },
  hi: {
    ...
    menuWindow: 'विंडो',
    menuHelp: 'सहायता',
    menuDocsHelp: 'Office AI Docs सहायता',
  },
  'zh-TW': {
    dlgOpenDoc: '開啟文件',
    filterWord: 'Word 文件',
    ...
    menuWindow: '視窗',
    menuHelp: '說明',
    menuDocsHelp: 'Office AI Docs 說明',
  },
})
...
/** default folder where new files land on their first (silent) save; shared with the other editors via shell. User-configurable (app-settings.json), falls back to <Documents>/Office AI. */
...
export function startDocsStandalone(): void {
  ...
  // the installed Office AI Docs is open and forwards its argv there instead.
  if (isDev) app.setPath('userData', join(app.getPath('appData'), 'Office AI Docs Dev'))
