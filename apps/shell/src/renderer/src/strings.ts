...
export const strings = {
  zh: {
    ...
    starPromptTitle: '喜欢 Office AI 吗？',
    starPromptTitleN: '你已经用 Office AI 打开了 {n} 个文档',
    starPromptBody: 'Office AI 是免费开源软件。到 GitHub 给我们一个 Star，是对团队最好的支持。',
    starPromptGo: '去点 Star',
    starPromptDone: '已经点过了',
    starPromptLater: '以后再说',
    onbStarHint: '如果你喜欢 Office AI，欢迎到 GitHub 给我们一个 Star。',
    setEmail: '邮箱',
    setNotLoggedIn: '未登录',
    setViewUsage: '查看用量',
    setChange: '更改',
    ...
    onbTitle1: '欢迎使用 Office AI',
    onbSubtitle1: '第一个开源的 AI 原生 Office 套件',
    onbBody1: '创建文档、制作表格、生成演示、审阅 PDF。AI 深度融入每个环节。',
    onbTitle2: '这只是一个开始',
    onbBody2: 'Office AI 目前处于 alpha 阶段。欢迎加入 GenTeam 群聊，分享反馈，一起塑造它的未来。',
  ...
  en: {
    ...
    starPromptTitle: 'Enjoying Office AI?',
    starPromptTitleN: "You've opened {n} documents with Office AI",
    starPromptBody:
      'Office AI is free and open source. A star on GitHub is the best way to support the team.',
    starPromptGo: 'Star on GitHub',
    starPromptDone: 'Already starred',
    starPromptLater: 'Maybe later',
    onbStarHint: 'If you like Office AI, give us a star on GitHub.',
    setEmail: 'Email',
    ...
    newTab: 'New tab',
    // First-run onboarding
    onbTitle1: 'Welcome to Office AI',
    ...
    onbBody2:
      'Office AI is still in alpha. Join the group chat on GenTeam to share feedback and help shape what comes next.',
  ...
  ja: {
    ...
    starPromptTitle: 'Office AI はいかがですか？',
    starPromptTitleN: 'Office AI で {n} 件のドキュメントを開きました',
    starPromptBody:
      'Office AI は無料のオープンソースソフトウェアです。GitHub のスターがチームへの何よりの応援になります。',
    starPromptGo: 'スターを付ける',
    starPromptDone: 'スター済み',
    starPromptLater: 'あとで',
    onbStarHint: 'Office AI が気に入ったら、GitHub でスターをお願いします。',
    setEmail: 'メール',
  ...
  ko: {
    ...
    starPromptTitle: 'Office AI가 마음에 드시나요?',
    starPromptTitleN: 'Office AI로 문서를 {n}개 열어보셨네요',
    starPromptBody:
      'Office AI는 무료 오픈 소스 소프트웨어입니다. GitHub 스타 하나가 팀에게 가장 큰 응원이 됩니다.',
    starPromptGo: '스타 누르기',
    starPromptDone: '이미 눌렀어요',
    starPromptLater: '나중에',
    onbStarHint: 'Office AI가 마음에 들면 GitHub에서 스타를 눌러 주세요.',
    setEmail: '이메일',
  ...
  fr: {
    ...
    starPromptTitle: 'Office AI vous plaît ?',
    starPromptTitleN: 'Vous avez ouvert {n} documents avec Office AI',
    starPromptBody:
      'Office AI est gratuit et open source. Une étoile sur GitHub est le meilleur moyen de soutenir l’équipe.',
    starPromptGo: 'Mettre une étoile',
    starPromptDone: 'Déjà fait',
    starPromptLater: 'Plus tard',
    onbStarHint: 'Si Office AI vous plaît, mettez-nous une étoile sur GitHub.',
    setEmail: 'E-mail',
    ...
    // First-run onboarding
    onbTitle1: 'Bienvenue dans Office AI',
    ...
    onbBody2:
      'Office AI est encore en alpha. Rejoignez la discussion de groupe sur GenTeam pour partager vos retours et façonner la suite.',
  ...
  de: {
    ...
    starPromptTitle: 'Gefällt Ihnen Office AI?',
    starPromptTitleN: 'Sie haben {n} Dokumente mit Office AI geöffnet',
    starPromptBody:
      'Office AI ist kostenlos und Open Source. Ein Stern auf GitHub ist die beste Unterstützung für das Team.',
    starPromptGo: 'Stern geben',
    starPromptDone: 'Schon erledigt',
    starPromptLater: 'Später',
    onbStarHint: 'Wenn Ihnen Office AI gefällt, geben Sie uns einen Stern auf GitHub.',
    setEmail: 'E-Mail',
    ...
    newTab: 'Neuer Tab',
    // First-run onboarding
    onbTitle1: 'Willkommen bei Office AI',
    ...
    onbBody2:
      'Office AI ist noch in der Alpha-Phase. Treten Sie dem Gruppenchat auf GenTeam bei, um Feedback zu teilen und die Zukunft mitzugestalten.',
  ...
  es: {
    ...
    starPromptTitle: '¿Te gusta Office AI?',
    starPromptTitleN: 'Has abierto {n} documentos con Office AI',
    starPromptBody:
      'Office AI es gratuito y de código abierto. Una estrella en GitHub es la mejor forma de apoyar al equipo.',
    starPromptGo: 'Dar una estrella',
    starPromptDone: 'Ya la di',
    starPromptLater: 'Más tarde',
    onbStarHint: 'Si te gusta Office AI, danos una estrella en GitHub.',
    ...
    // First-run onboarding
    onbTitle1: 'Bienvenido a Office AI',
    ...
    onbBody2:
      'Office AI aún está en alfa. Únete al chat grupal en GenTeam para compartir comentarios y ayudar a dar forma a lo que viene.',
  ...
  th: {
    ...
    starPromptTitle: 'ชอบ Office AI ไหม?',
    starPromptTitleN: 'คุณเปิดเอกสารด้วย Office AI ไปแล้ว {n} ไฟล์',
    starPromptBody:
      'Office AI ฟรีและเป็นโอเพนซอร์ส การกดดาวบน GitHub คือกำลังใจที่ดีที่สุดสำหรับทีม',
    starPromptGo: 'กดดาวเลย',
    starPromptDone: 'กดแล้ว',
    starPromptLater: 'ไว้ทีหลัง',
    onbStarHint: 'ถ้าชอบ Office AI ฝากกดดาวให้เราบน GitHub ด้วยนะ',
    setEmail: 'อีเมล',
    ...
    newTab: 'แท็บใหม่',
    // First-run onboarding
    onbTitle1: 'ยินดีต้อนรับสู่ Office AI',
    ...
    onbBody2:
      'Office AI ยังอยู่ในช่วงอัลฟ่า เข้าร่วมแชทกลุ่มบน GenTeam เพื่อแบ่งปันความคิดเห็นและร่วมกำหนดทิศทางต่อไป',
  ...
  id: {
    ...
    starPromptTitle: 'Suka Office AI?',
    starPromptTitleN: 'Anda telah membuka {n} dokumen dengan Office AI',
    starPromptBody:
      'Office AI gratis dan open source. Bintang di GitHub adalah dukungan terbaik untuk tim kami.',
    starPromptGo: 'Beri Bintang',
    starPromptDone: 'Sudah',
    starPromptLater: 'Nanti saja',
    onbStarHint: 'Jika Anda menyukai Office AI, beri kami bintang di GitHub.',
    setEmail: 'Email',
    ...
    newTab: 'Tab baru',
    // First-run onboarding
    onbTitle1: 'Selamat datang di Office AI',
    ...
    onbBody2:
      'Office AI masih dalam tahap alpha. Gabung obrolan grup di GenTeam untuk berbagi masukan dan ikut menentukan arah ke depan.',
  ...
  ru: {
    ...
    starPromptTitle: 'Нравится Office AI?',
    starPromptTitleN: 'Вы уже открыли {n} документов в Office AI',
    starPromptBody:
      'Office AI — бесплатное ПО с открытым кодом. Звезда на GitHub — лучшая поддержка для команды.',
    starPromptGo: 'Поставить звезду',
    starPromptDone: 'Уже поставлена',
    starPromptLater: 'Позже',
    onbStarHint: 'Если вам нравится Office AI, поставьте нам звезду на GitHub.',
    setEmail: 'Эл. почта',
    ...
    // First-run onboarding
    onbTitle1: 'Добро пожаловать в Office AI',
    ...
    onbBody2:
      'Office AI пока в альфа-версии. Присоединяйтесь к групповому чату в GenTeam, чтобы делиться отзывами и влиять на дальнейшее развитие.',
  ...
  ar: {
    ...
    starPromptTitle: 'هل أعجبك Office AI؟',
    starPromptTitleN: 'لقد فتحت {n} من المستندات في Office AI',
    starPromptBody: 'Office AI مجاني ومفتوح المصدر. نجمة على GitHub هي أفضل دعم للفريق.',
    starPromptGo: 'ضع نجمة',
    starPromptDone: 'وضعتها بالفعل',
    starPromptLater: 'لاحقًا',
    onbStarHint: 'إذا أعجبك Office AI، ضع لنا نجمة على GitHub.',
    ...
    // First-run onboarding
    onbTitle1: 'مرحبًا بك في Office AI',
    ...
    onbBody2:
      'لا يزال Office AI في مرحلة ألفا. انضم إلى الدردشة الجماعية على GenTeam لمشاركة ملاحظاتك والمساهمة في تشكيل المستقبل.',
  ...
  pt: {
    ...
    starPromptTitle: 'Gostando do Office AI?',
    starPromptTitleN: 'Você já abriu {n} documentos com o Office AI',
    starPromptBody:
      'O Office AI é gratuito e de código aberto. Uma estrela no GitHub é a melhor forma de apoiar a equipe.',
    starPromptGo: 'Dar uma estrela',
    starPromptDone: 'Já dei',
    starPromptLater: 'Mais tarde',
    onbStarHint: 'Se você gosta do Office AI, deixe uma estrela no GitHub.',
    setEmail: 'E-mail',
    ...
    newTab: 'Nova guia',
    // First-run onboarding
    onbTitle1: 'Bem-vindo ao Office AI',
    ...
    onbBody2:
      'O Office AI ainda está em alfa. Entre no chat em grupo no GenTeam para compartilhar feedback e ajudar a moldar o que vem a seguir.',
  ...
  it: {
    ...
    starPromptTitle: 'Ti piace Office AI?',
    starPromptTitleN: 'Hai aperto {n} documenti con Office AI',
    starPromptBody:
      'Office AI è gratuito e open source. Una stella su GitHub è il modo migliore per sostenere il team.',
    starPromptGo: 'Metti una stella',
    starPromptDone: 'Già fatto',
    starPromptLater: 'Più tardi',
    onbStarHint: 'Se ti piace Office AI, lasciaci una stella su GitHub.',
    setEmail: 'Email',
    ...
    newTab: 'Nuova scheda',
    // First-run onboarding
    onbTitle1: 'Benvenuto in Office AI',
    ...
    onbBody2:
      'Office AI è ancora in alpha. Unisciti alla chat di gruppo su GenTeam per condividere feedback e contribuire a plasmare il futuro.',
  ...
  pl: {
    ...
    starPromptTitle: 'Podoba Ci się Office AI?',
    starPromptTitleN: 'Otwarto już {n} dokumentów w Office AI',
    starPromptBody:
      'Office AI jest darmowy i open source. Gwiazdka na GitHubie to najlepsze wsparcie dla zespołu.',
    starPromptGo: 'Daj gwiazdkę',
    starPromptDone: 'Już zrobione',
    starPromptLater: 'Później',
    onbStarHint: 'Jeśli podoba Ci się Office AI, zostaw nam gwiazdkę na GitHubie.',
    setEmail: 'E-mail',
    ...
    onbBody2:
      'Office AI jest wciąż w fazie alfa. Dołącz do czatu grupowego na GenTeam, aby dzielić się opiniami i współtworzyć jego przyszłość.',
  ...
  nl: {
    ...
    starPromptTitle: 'Bevalt Office AI?',
    starPromptTitleN: 'Je hebt al {n} documenten geopend met Office AI',
    starPromptBody:
      'Office AI is gratis en open source. Een ster op GitHub is de beste steun voor het team.',
    starPromptGo: 'Geef een ster',
    starPromptDone: 'Al gedaan',
    starPromptLater: 'Later',
    onbStarHint: 'Als Office AI je bevalt, geef ons dan een ster op GitHub.',
    setEmail: 'E-mail',
    ...
    // First-run onboarding
    onbTitle1: 'Welkom bij Office AI',
    ...
    onbBody2:
      'Office AI is nog in alfa. Doe mee aan de groepschat op GenTeam om feedback te delen en mee te bepalen wat er komt.',
  ...
  ms: {
    ...
    starPromptTitleN: 'Anda telah membuka {n} dokumen dengan Office AI',
    starPromptBody:
      'Office AI percuma dan sumber terbuka. Bintang di GitHub ialah sokongan terbaik untuk pasukan kami.',
    starPromptGo: 'Beri Bintang',
    starPromptDone: 'Sudah',
    starPromptLater: 'Kemudian',
    onbStarHint: 'Jika anda suka Office AI, beri kami bintang di GitHub.',
    setEmail: 'E-mel',
    ...
    newTab: 'Tab baharu',
    // First-run onboarding
    onbTitle1: 'Selamat datang ke Office AI',
    ...
    onbTitle2: 'Ini baru permulaan',
    onbBody2:
      'Office AI masih dalam peringkat alfa. Sertai sembang kumpulan di GenTeam untuk berkongsi maklum balas dan membentuk masa depannya.',
  ...
  he: {
    ...
    starPromptTitle: 'נהנים מ-Office AI?',
    starPromptTitleN: 'פתחת {n} מסמכים עם Office AI',
    starPromptBody: 'Office AI חינמי ובקוד פתוח. כוכב ב-GitHub הוא התמיכה הטובה ביותר בצוות.',
    starPromptGo: 'לתת כוכב',
    starPromptDone: 'כבר נתתי',
    starPromptLater: 'אחר כך',
    onbStarHint: 'אם Office AI מוצא חן בעיניכם, תנו לנו כוכב ב-GitHub.',
    setEmail: 'אימייל',
    ...
    // First-run onboarding
    onbTitle1: 'ברוכים הבאים ל-Office AI',
    ...
    onbBody2:
      'Office AI עדיין בגרסת אלפא. הצטרפו לצ׳אט הקבוצתי ב-GenTeam כדי לשתף משוב ולעזור לעצב את ההמשך.',
  ...
  hi: {
    ...
    starPromptTitle: 'Office AI पसंद आ रहा है?',
    starPromptTitleN: 'आपने Office AI में {n} दस्तावेज़ खोले हैं',
    starPromptBody:
      'Office AI मुफ़्त और ओपन सोर्स है। GitHub पर एक स्टार टीम का सबसे अच्छा समर्थन है।',
    starPromptGo: 'स्टार दें',
    starPromptDone: 'पहले ही दे दिया',
    starPromptLater: 'बाद में',
    onbStarHint: 'अगर आपको Office AI पसंद है, तो हमें GitHub पर स्टार दें।',
    setEmail: 'ईमेल',
    ...
    newTab: 'नया टैब',
    // First-run onboarding
    onbTitle1: 'Office AI में आपका स्वागत है',
    ...
    onbBody2:
      'Office AI अभी अल्फ़ा में है। GenTeam पर ग्रुप चैट से जुड़ें, फ़ीडबैक साझा करें और आगे की दिशा तय करने में मदद करें।',
  ...
  'zh-TW': {
    ...
    starPromptTitle: '喜歡 Office AI 嗎？',
    starPromptTitleN: '你已經用 Office AI 開啟了 {n} 個文件',
    starPromptBody: 'Office AI 是免費的開源軟體。到 GitHub 給我們一顆星，是對團隊最好的支持。',
    starPromptGo: '去給星星',
    starPromptDone: '已經給過了',
    starPromptLater: '以後再說',
    onbStarHint: '如果你喜歡 Office AI，歡迎到 GitHub 給我們一顆星。',
    setEmail: '電子郵件',
    setNotLoggedIn: '未登入',
    setViewUsage: '查看用量',
    setChange: '變更',
    ...
    newTab: '新分頁',
    // First-run onboarding
    onbTitle1: '歡迎使用 Office AI',
    onbSubtitle1: '第一個開源的 AI 原生 Office 套件',
    onbBody1: '建立文件、製作試算表、產生簡報、審閱 PDF。AI 深度融入每個環節。',
    onbTitle2: '這只是一個開始',
    onbBody2: 'Office AI 目前仍在 alpha 階段。歡迎加入 GenTeam 群聊，分享回饋，一起打造它的未來。',
